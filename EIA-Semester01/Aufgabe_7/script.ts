...
function Music() {
    ...
    var beat:any[] = ["Sounds/assets_5.mp3", "Sounds/assets_1.mp3", "Sounds/assets_2.mp3", "Sounds/assets_3.mp3", "Sounds/assets_4.mp3"];
    var bass:any[] = ["Sounds/assets_6.mp3", "Sounds/assets_7.mp3"]
    function Bass() {
        var min = 0;
        var max = 2;
        var index = Math.floor(Math.random() * (max - min + 1)) + min;
        var sound:HTMLAudioElement = new Audio(bass[index]);
        sound.play();
    };
    function Rythm() {
        var min = 0;
